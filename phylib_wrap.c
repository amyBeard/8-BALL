...
SWIGINTERN PyObject *_wrap_phylib_print_object(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  phylib_object *arg1 = (phylib_object *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_phylib_object, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "phylib_print_object" "', argument " "1"" of type '" "phylib_object *""'"); 
  }
  arg1 = (phylib_object *)(argp1);
  phylib_print_object(arg1);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "phylib_print_object", _wrap_phylib_print_object, METH_O, NULL},
